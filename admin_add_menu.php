                                            ...
                                            if($result2){
                                                ...
                                                echo   '<tr>
                                                            ...
                                                            <button data-id="'.$subid.'" class="btn btn-info btn-sm pop2" id="pop2">Update</button>
                                                                <button class="btn btn-danger btn-sm"><a href="admin_delete_menu.php?p_deleteid='.$subid.'" class="text-light">Delete</a></button>
                                                            </td>
                                                        </tr>';
                                                    }
                                                }
                                       ...
                                       if($result3){
                                           ...
                                           echo   '<tr>
                                                       ...
                                                       <td>
                                                           ...
                                                           <button class="btn btn-danger btn-sm"><a href="admin_delete_menu.php?fm_deleteid='.$feaid.'" class="text-light">Delete</a></button>
                                                       </td>
                                                   </tr>';
                                               }
                                           }
